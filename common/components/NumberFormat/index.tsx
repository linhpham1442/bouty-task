...
type NumberFormatProps = typeof propTypes;
...
class NumberFormat extends React.Component<any> {
  ...
  formatAsNumber(numStr: string) {
    ...
    if (decimalScale !== undefined)
      afterDecimal = limitToScaleDynamic(afterDecimal, decimalScale, fixedDecimalScale);
  ...
  formatValueProp(defaultValue: string | number) {
    ...
    if (isNumericString && !format && typeof decimalScale === "number") {
      value = roundToPrecision(value, decimalScale, fixedDecimalScale, true);
    }
